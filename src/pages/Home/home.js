...
const Home = () => {
  ...
  return (
    <>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="aboutMe">
                  <h4>About me</h4>
                  <p>
                    I'm Full-Stack Front-end Focus Developer in React Or Next
                    JS. I specialize in Front-end custom coding design and
                    Webfollw in development. I specialize in Convert Figma, PSD,
                    OR XD File Landing page Designer. I'm always striving to
                    grow and learn something new and I take myself to seriously.
                    I'm passionate about helping startups grow, improve their
                    customer experience, and to raise venture capital throught
                    good design.
                  </p>
                  <Link>Read more</Link>
                </div>
      ...
      <Footer styleClass={style2}></Footer>
    </>
  );
};
